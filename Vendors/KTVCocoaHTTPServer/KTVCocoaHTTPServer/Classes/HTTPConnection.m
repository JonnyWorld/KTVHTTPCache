...
- (void)replyToHTTPRequest
{
	...
	if ([CocoaWebSocket isWebSocketRequest:request])
	{
		HTTPLogVerbose(@"isWebSocket");
		
        CocoaWebSocket *ws = [self webSocketForURI:uri];
...
- (CocoaWebSocket *)webSocketForURI:(NSString *)path
{
	HTTPLogTrace();
